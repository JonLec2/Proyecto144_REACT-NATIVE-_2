...
export default class PopularScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [],
      ngrok_url:"https://9bd3-2806-103e-c-24bb-1d97-af01-baf6-fca2.ngrok-free.app"
    };
  }

 /*define la función getData() aquí*/
 getData(){
  const urldata=this.state.ngrokurl+"/recommended_articles"
  axios
  .get(urldata)
  .then(async(response)=>{
    ...
    <View style={styles.cardContainer}>
      ...
      <View style={styles.movieTitleContainer}>
        ...
        <View style={{flexDirection:"row"}}>
          ...
          <Star score={item.raiting} style={styles.starStyle}></Star>
        </View>
      </View>
    </View>
  )
